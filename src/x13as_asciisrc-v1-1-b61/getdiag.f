...
c-----------------------------------------------------------------------
     ...
     &        oCycAR, oCycMA, oSAAR, oSAMA, oTAAR, oTAMA, oMA
...
c-----------------------------------------------------------------------
      IF (( nDiff(1) .eq. 0 ).and.( nDiff(2) .eq. 0)) THEN
       IF(Issap.lt.2.and.Irev.lt.4)WRITE(STDERR,100)
       WRITE(Mt2,100)
  100  FORMAT( ' *** No differencing provided, finite sample',
     &         ' diagnostic processing aborted. ***' )
       RETURN
      END IF
c-----------------------------------------------------------------------
c     bldDif processing
