C     Last change:Oct. 26,2023, Corrects program output for AICC testing
C     when a p-value for AIC testing is specified
C     previous change:  BCM  23 Mar 2005    9:23 am
...
c     change format to correct output BCM June 2023
 1040 FORMAT(/,'<p class="center">***** <abbr title="corrected ',
     &         'Akaike information criterion">AICC</abbr>',
     &       /,' (with p-value = ',F7.5,
     &         ' and <abbr title="A I C diff">',
     &       /,'aicdiff</abbr> = ',F7.4,
     &         ') prefers model <strong>',a,
     &         ' user-defined regressor</strong> *****</p>')
      RETURN
      END
